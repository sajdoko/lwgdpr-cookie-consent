...
class Lw_Gdpr_Cookie_Consent_Cookie_Custom {
	...
	public function settings_form() {
		...
		wp_enqueue_script( 'gdprcookieconsent_cookie_custom', plugin_dir_url( __FILE__ ) . 'assets/js/cookie-custom' . GDPR_CC_SUFFIX . '.js', array(), LW_GDPR_COOKIE_CONSENT_VERSION, true );
		$params = array(
			'nonces'           => array(
