...
Contributors: sajdoko-club
Donate link: https://www.localweb.it//product/wp-lwgdpr-cookie-consent/
...
>
> <cite>[lwgdpr.eu](https://lwgdpr.eu/cookies/)</cite>
...
>
> See the [complete list of features here](https://www.localweb.it//product/wp-lwgdpr-cookie-consent/?utm_source=wporg&utm_campaign=lwgdpr-cookie-consent&utm_content=lwgdpr-cookie-consent-pro-plugin).
...
1. Upload the `lwgdpr-cookie-consent` folder to the `/wp-content/plugins/` directory
